...
def form_pers_nat(request):
    return render(request, 'pages/dashboards/form_pers_nat.html')

def form_pers_jur(request):
    return render (request, 'pages/dashboards/form_pers_jur.html')

def form_pers_nat_rut(request):
    return render (request, 'pages/dashboards/form_per_nat_rut.html')

def form_pert_emp(request):
    return render (request, 'pages/dashboards/form_pert_emp.html')

def form_prof_titu(request):
    return render (request, 'pages/dashboards/form_prof_titu.html')

def form_fe_pj(request):
    return render (request, 'pages/dashboards/form_fe_pj.html')

def form_fe_pn(request):
    return render (request, 'pages/dashboards/form_fe_pn.html')

def form_func_pub(request):
    return render (request, 'pages/dashboards/form_func_pub.html')

def form_siif_nac(request):
    return render (request, 'pages/dashboards/form_siif_nac.html')

def form_com_acad(request):
    return render (request, 'pages/dashboards/form_com_acad.html')
